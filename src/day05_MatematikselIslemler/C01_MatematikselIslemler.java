...
public class C01_MatematikselIslemler {
	...
	System.out.println(4*(2+5)/3);//9 bütün rakamlar int olduðu için sonuc int oldu.
	System.out.println(4*(2+5)/3.6);//7.777777777777778 double sayi olduðu için sonuc double oldu
