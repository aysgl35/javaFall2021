...
public class C04_DateTimeFormatter {
	...
	public static void main(String[] args) {
		...
		LocalDate tarih=LocalDate.of(2016, 06, 30);
		DateTimeFormatter duzenle1 = DateTimeFormatter.ofPattern("DDD / MM / YYYY EEEE ");
		System.out.println(duzenle.format(tarihSaat)); // 
		System.out.println(duzenle1.format(tarih)); 
		/*
		 format olustururken
		 GUN
